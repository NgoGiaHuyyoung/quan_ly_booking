...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                <h3 class="mb-3">Lorem insum dolor sit</h3>
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni,
                    velit, quae quidem assumenda, quod commodi ratione iusto animi
                    et explicabo accusamus fugit nulla impedit beatae vel reiciendis
                    fugiat minima possimus?
                </p>
            </div>
    ...
    <div class="container nt-5">
        <div class="row">
            <div class="col-lg-3 col-md-6 nb-4 px-4">
